...
static DX_TIMER_BINDING tmr_request_telemetry = {.period = {15, 0}, .name = "tmr_request_telemetry", .handler = request_telemetry_handler};
...
DX_TIMER_BINDING *timer_bindings[] = {&tmr_request_telemetry};